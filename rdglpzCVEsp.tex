...
\makeheading{\begin{tabular}{l P{65mm}}
Rodrigo López Farías. \\ \footnotesize{\textit{Dr. en Ciencias de la Computación e Ingeniería}} &	 \footnotesize{\textit{Actualizado al: \today}.}	
\end{tabular}
}  


\section{Información Personal} 
\begin{tabular}{l P{58mm} M{5mm}}
Nacimiento: 8-Jul-1984		&	e-mail:  rdglpz@gmail.com	& \multirow{2}{*}[1cm]{\includegraphics[width=2.2cm]{foto2.jpg}  } 	\\
Dirección: Membrillo \# 306, Int 3		&  Celular: +52 443 155 5416	 		&	\\
...
\section{Empleo Reciente}
\textbf{Coordinación y Gestión de Servicios de Tecnologías de Información y Comunicaciones (CGSTIC) del Centro de Investigación y Estudios Avanzados del Instituto Politécnico Nacional (CINVESTAV-IPN)}. \textit{(Oct/2016 - Actualidad)}.
