...
\makeheading{\begin{tabular}{l P{40mm}}
  &  \footnotesize{Actualizado:}   \\
Dr. Rodrigo López Farías. \footnotesize{\textit{Ciencias de la Computación e Ingeniería.}  } & \footnotesize{\textit{\today}}
\end{tabular}
}  
...
Delegación: Azcapotzalco	&  Celular: +52 443 155 5416	 		&	\\
Código Postal: 02820		& 	Skype ID: rdglpz  			&	\\
Ciudad de México         		&	ORCID ID: 0000-0003-2772-0051						&
\end{tabular}

\blankline

\section{Empleo Actual}
\textbf{Instituto:} Centro de Investigación y Estudios Avanzados del Instituto Politécnico Nacional (CINVESTAV-IPN). Ciudad de México. \textit{(Oct/2016 - Actualidad)}

\textbf{Departamento:} oordinación y Gestión de Servicios de Tecnologías de Información y Comunicaciones (CGSTIC).

\textbf{Actividad:} Desarrollo de agentes conversacionales inteligentes manejando gran volumen de información (Big Data) y Aprendizaje Automático (Machine Learning).

\blankline


\section{Intereses \& Habilidades  } \textbf{Lenguajes de Programación y Manejadores de Bases de Datos}
