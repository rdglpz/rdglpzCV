...
Catedrático de tiempo completo, perteneciente al SNI (Nivel Candidato) del Consejo Nacional de Ciencia y Tecnología (CONACyT) comisionado al Centro de Investigación en
Ciencias de Información Geoespacial (CentroGeo) al proyecto \textit{``Modelado espacio-temporal en y entre ciudades''} del Centro de Investigación en Ciencias de Información Geoespacial (CentroGeo).  \textit{(Desde el 1 de Noviembre del 2017)}. 
