...
\begin{tabular}{l r}
  &    \\
Dr. Rodrigo López Farías.\footnotesize{\textit{Ciencias de la Computación e Ingeniería.}  } &  \tiny{Actualizado:\textit{\today, (dd/mm/yyyy)} }
\end{tabular}
}  
...
Nacimiento: 8/7/1984 		&	e-mail:  rdglpz@gmail.com	& 
...
\begin{innerlist}
\item \textbf{``Generation of synthetic Day Scenarios for Renewable energy Production Using Generative Adversarial Networks''}. Revisor y vocal de Tesis. M.C. de Josué Daniel González Parra, de la Universidad Michoacana de San Nicolás de HidalgoTesis para obtener el grado de Maestría en Ciencias de Ingeniería Eléctrica.  23/Ago/2021.
