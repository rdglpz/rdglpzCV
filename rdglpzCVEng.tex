...
Machine Learning, (SVM, Artificial Neural Networks, Fuzzy Logic). Data mining (efficient algorithms for nearest neighbors search), modelling and time series forecasting. Probabilistic Multi-model forecasting (Bayesian Approach). Global Optimization with Evolutionary Computing, stability analysis and parameter Identification of non-linear dynamical systems. %Dimensionality reduction, time series, nonlinear dynamical systems, global optimization, evolutionary computing.
