...
\begin{document}
\small{
\makeheading{Dr. Rodrigo L\'{o}pez Far\'{i}as (Last update. \textit{29 / Feb / 2016} )}  
...
\item[] {Computational Systems Engineer (specialization: networking and distributed systems)}.
\end{outerlist}
%
