...
\small{
\makeheading{Ph.D. Rodrigo L\'{o}pez Far\'{i}as \tiny{(Updated: \textit{12 / Aug / 2016} )}}  

\section{Personal Information}\begin{tabular}{l P{70mm} M{20mm}}{Birthday: 8 / Jul / 1984} 		& 	e-mail: rodrigo.lopez@alumni.imtlucca.it	 						& \multirow{4}{*}[1.3cm]{\includegraphics[width=2.4cm]{foto.png}  } 	\\
{Address: Aram\'{e}n \# 313}	&    ORCID ID: 0000-0003-2772-0051	   	 	&	\\
Postal (ZIP) Code: 58070           			& 		Skype ID: rdglpz					&	\\
Morelia, Mexico         		&	Cellular: +52 443 155 5416  & %	Cellular: +52 443 155 5416  												&
\end{tabular}
...
English: 550 ITP TOEFL points. Italian: B1 Common CEFRL Level. 




\section{Academic Degree} {\textbf{Ph.D. in Computer Science and Engineering }}(W. European Doctorate mention). \textit{Lucca, Italy. (February 2012 - January 2016)}
...
{\textbf{B.Eng. in Computational Systems}}. 
...
\begin{innerlist}
\item  Structured programming and object oriented programming (In Electronic and  Industrial Engineering), Research Methodology (In Computational Systems Engineering).  
\end{innerlist}
...
\hfill \textbf{January 2011 - July 2011}
	...
	\begin{innerlist}
		\item  Operative systems, selected topics in programming and research fundamentals.
	\end{innerlist}
...
\begin{outerlist}
\item[] \textit{Resident in physical infrastructure department}%
...
\section{Publications} \textbf{Refereed Journal Articles}
...
\begin{innerlist}
\item \textit{Hector Rodriguez Rangel, Vicenc Puig, Rodrigo L\'{o}pez Far\'{i}as, Juan J. Flores }.  Short-Term Demand Forecast using Bank of Neural Network Models Trained using Genetic Algorithms for the Optimal Management of Drinking Water Networks.  \textit{Journal of Engineering Applications of Artificial Intelligence}.(2016)
...
\begin{innerlist}
\item \textit{Juan J. Flores, Felix Calderon Solorio, Jose Rafael Cede\~no Gonzalez, Jose Ortiz Bejar and Rodrigo Lopez Farias}.  Comparison of Time Series Forecasting Techniques with respect to Tolerance to Noise \textit{IEEE Autumn Meeting on Power, Electronics and Computing} \textbf{Ixtapa M\'{e}xico, November 2016 } (Under Revision).
...
\item \textit{Hector Rodriguez-Rangel, Vicenc Puig, Juan J. Flores and ,  Rodrigo L\'{o}pez} Far\'{i}as.  Flow meter Data Validation and Reconstruction using Neural Networks: Application to the Barcelona Water Network \textbf{3rd International Conference on Control and Fault-Tolerant Systems, Barcelona, Spain. 2016} (To be published).

\item \textit{Hector Rodriguez Rangel, Vicenc Puig,Juan J. Flores and ,  Rodrigo L\'{o}pez Far\'{i}as.  Flow meter Data Validation and Reconstruction using Neural Networks: Application to the Barcelona Water Network} \textbf{2016 European Control Conference, Aalborg, Denmark. June 2016}.
...
\item \textit{Rodrigo. L\'{o}pez, Vicenc Puig, Hector Rodriguez}   An implementation of a multi-model predictor based on the qualitative and quantitative decomposition of the time-series \textit{International work-conference on Time Series 1 
} \textbf{Granada Spain, July 2015}.
