...
Ph.D. Rodrigo L\'{o}pez Far\'{i}as         		&	\small{\textit{6 / Sept / 2016}}  				
\end{tabular}}  

\section{Personal Information}

\begin{tabular}{l P{70mm} M{20mm}}
Birthday: 8 / Jul / 1984		&	e-mail: rodrigo.lopez@alumni.imtlucca.it	& \multirow{4}{*}[1.3cm]{\includegraphics[width=2.4cm]{foto.png}  } 	\\
Address: Aram\'{e}n \# 313		&   ORCID ID: 0000-0003-2772-0051				&	\\
Postal (ZIP) Code: 58070		& 	Skype ID: rdglpz							&	\\
Morelia, Mexico         		&	Cellular: +52 443 155 5416  				&
\end{tabular}
...
\textbf{IMT School for Advanced Studies Lucca}
		\begin{outerlist}
        	...
        	\item Field of study: Time series analysis.
	    \end{innerlist}
		\end{outerlist}
...
\begin{outerlist}
	    ...
	    \begin{innerlist}
        	\item Field of study: Application of distributed operative Systems.
	    \end{innerlist}
\end{outerlist}
