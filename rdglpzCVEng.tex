...
\makeheading{\begin{tabular}{l P{30mm}}
...
\begin{tabular}{l P{45mm} M{10mm}}
Birthday: 8/Jul/1984		&	rdglpz@gmail.com	& 
\multirow{2}{*}[0.2cm]{\includegraphics[width=2.0cm]{images/foto2017.png}  } 	\\
Residence: Corregidora, Queretaro  	&  phone: +52 4431555416	 		&	\\
		& 	Skype ID: rdglpz  			&	\\
...
\section{Current Job}
Research fellow for the National Council on Science and Technology (CONACyT) commissioned at the Center for Research of Geospatial Information Sciences (CentroGeo) in the Geocomputational Intelligence department (Since Nov 2017).

\section{Grants and Distinctions}
Member of the Mexican System of Researchers (SNI - 1).
...
\textbf{National Autonomous University of Mexico (UNAM) Campus Juriquilla. Juriquilla, Querétaro, México}. (20/Aug/2020).

\blankline

\begin{innerlist}

\item \textbf{Coach of Social Service project.} Student: Ariel Cerón González. Title: "Software para sistematizar validación de modelos de reconstrucción de series de tiempo con aplicación al estudio de concentraciones de contaminantes PM2.5" 

\end{innerlist}

\blankline

\textbf{Polytechnic University of Querétaro. Querétaro, México}. (8/Apr/2019).


\blankline

\begin{innerlist}
\item \textbf{Coach of Social Service project.} Student: Josué Oropeza Juarez. Title: "Implementación de un servidor web para adquisición, almacenamiento y visualización de datos enviados por sensores para estudio de zonas metropolitanas". 

\item  \textbf{Coach of Social Service project.} Student: Luis Gutierrez Astudillo. Title: "Implementación de un prototipo de una unidad de monitoreo de contaminantes para las metrópolis de bajo costo conectada a una red local sencilla TCP/IP".
...
\textbf{Center for Information and Communications Technologies (CETIC)}. \textit{(Mar}\textit{/2007} - \textit{Jun/2007)}.
Morelia, Mexico.
...
\section{Publications} \textbf{Articles Published in Journal Citation Reports Journals}
...
\section{Participation as organizer in Academic Events}

\textbf{Recent important academic events}

\begin{innerlist}



\item Coordinator of the track `` Urban Sustainability and Environment'' in Metropolitan Perspectives. \textbf{Queretaro, Feb/2019. }
\item Coordinator of the track ``Scientific Computing Applied to Geospatial Problems'' in the 2021 ``Computational National Meeting, ENC''.  \textbf{Morelia,}  \textbf{Aug/2021}.
