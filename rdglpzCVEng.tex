...
Ph.D. Rodrigo L\'{o}pez Far\'{i}as         		&	\small{\textit{12 / Sept / 2016}}  				
\end{tabular}}  
...
\textbf{MSc in Electrical Engineering (Branch: Computational Systems)}.
...
Instituto Tecnologico de Morelia. Morelia, México. \textit{(2002 2007)}.
...
\begin{innerlist}
\item \textit{Hector Rodriguez Rangel, Vicen\c{c} Puig, Rodrigo L\'{o}pez Far\'{i}as, Juan J. Flores }.  Short-Term Demand Forecast using Bank of Neural Network Models Trained using Genetic Algorithms for the Optimal Management of Drinking Water Networks.  \textit{Journal of Engineering Applications of Artificial Intelligence}.(2016)
